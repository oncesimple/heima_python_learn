...
from 爬虫.code.APP爬虫.douyin.handle_mongo import get_task, save_data
...
def handle_decode(input_data, share_web_url, task):
    ...
    share_web_html.xpath("//div[@class='personal-card']/div[@class='info2']/p[@class='extra-info']/span[1]/text()")[0]
    douyin_info['xingzuo'] = \
    share_web_html.xpath("//div[@class='personal-card']/div[@class='info2']/p[@class='extra-info']/span[2]/text()")[0]
    douyin_info['follow_count'] = share_web_html.xpath(
        "//div[@class='personal-card']/div[@class='info2']/p[@class='follow-info']//span[@class='focus block']//i[@class='icon iconfont follow-n']/text()")[
        0].strip( )
    fans_value = ''.join(share_web_html.xpath(
        "//div[@class='personal-card']/div[@class='info2']/p[@class='follow-info']//span[@class='follower block']//i[@class='icon iconfont follow-n']/text()"))
    unit = share_web_html.xpath(
        "//div[@class='personal-card']/div[@class='info2']/p[@class='follow-info']//span[@class='follower block']/span[@class='n']/text()")
    if unit[-1].strip( ) == 'w':
        douyin_info['fans'] = str((int(fans_value) / 10)) + 'w'
    like = ''.join(share_web_html.xpath(
        "//div[@class='personal-card']/div[@class='info2']/p[@class='follow-info']//span[@class='liked-n block']//i[@class='icon iconfont follow-n']/text()"))
    unit = share_web_html.xpath(
        "//div[@class='personal-card']/div[@class='info2']/p[@class='follow-info']//span[@class='liked-n block']/span[@class='n']/text()")
    if unit[-1].strip( ) == 'w':
